...
public class YggdrasilAuthenticator {
	...
	public static interface PasswordProvider {
		 ...
		 *             If the username cannot be provided
		 */
		 ...
		 * @return the password
		 * @throws AuthenticationException
		 *             If the password cannot be provided
		 */
	 ...
	 *            the access token
	 * @param service
	 *            the customized {@link AuthenticationService}
	 * @return a YggdrasilAuthenticator
	 * @throws AuthenticationException
	 *             If an exception occurs during the
	 *             authentication
	 ...
	 *
	 * @throws AuthenticationException
	 *             if <code>YggdrasilAuthenticator</code>
