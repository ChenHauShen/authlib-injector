...
import static org.to2mbn.authlibinjector.util.HttpUtils.withUrlArguments;
...
import org.to2mbn.authlibinjector.login.yggdrasil.core.GameProfileCallback;
import org.to2mbn.authlibinjector.login.yggdrasil.core.ProfileNotFoundException;
import org.to2mbn.authlibinjector.login.yggdrasil.core.ProfileService;
import org.to2mbn.authlibinjector.login.yggdrasil.core.PropertiesGameProfile;
import org.to2mbn.authlibinjector.login.yggdrasil.core.texture.Texture;
import org.to2mbn.authlibinjector.login.yggdrasil.core.texture.TextureType;
import org.to2mbn.authlibinjector.login.yggdrasil.core.texture.Textures;
...
class YggdrasilProfileService extends AbstractYggdrasilService implements ProfileService {
	...
	public Map<TextureType, Texture> getTextures(final PropertiesGameProfile profile) throws AuthenticationException {
		...
		return invokeOperation(() -> parseTextures(profile.getProperties()));
	}
	...
	private Map<TextureType, Texture> parseTextures(Map<String, String> properties) {
		...
		JSONObject payload = asJson(Base64.getDecoder().decode(encodedTextures));
	...
	public GameProfile lookupGameProfile(final String name) throws AuthenticationException {
		...
		return invokeOperation(() -> getAndParseGameProfile(url));
	}
